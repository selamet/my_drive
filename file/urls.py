...
from file.views import category_detail, parent_categories, document_detail, upload_file, upload_file_step1, doc_remove
...
urlpatterns = [
    ...
    path('doc-remove/<slug:slug>', doc_remove, name='doc-remove')
]
